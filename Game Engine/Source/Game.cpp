...
void Game::StartGame()
{
	...
	HUDActor->SetPosition(Vector3(0, 700, 0));
	mMessage->SetText("Toggle Shaders: 1- Negative 2 - Light Scatter 3 - Pixelate 4 - Toon 5- Radial Blur 6 - Motion Blur 7 - Bloom 8 - Depth", Color::Pink, 40);
