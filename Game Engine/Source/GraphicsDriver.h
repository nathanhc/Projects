...
public:
	...
	GraphicsTexturePtr GetShaderResource()
	{
		return mShaderResource;
	}

	GraphicsTexturePtr GetDepthResource()
	{
	...
	RenderTargetPtr CreateRenderTargetTexture(int inWidth, int inHeight, ETextureFormat inTextureFormat);
...
private:
	...
	GraphicsTexturePtr resources[2];
};
