...
public:
	...
	std::unordered_map<PShader, ShaderPtr> GetPShaders() { return mPostProcessShaders; }
	std::unordered_map<EMeshShader, ShaderPtr> GetMShaders() { return mMeshShaders; }
	ShaderPtr GetPostProcess() { return mPostProcess; }
...
private:
	...
	// Project Stuff
	RenderTargetPtr mTextureTarget;
	GraphicsTexturePtr mShaderResource;
	GraphicsTexturePtr mDepthResource;

	ShaderPtr mBlurShader;
	ShaderPtr mToonShader;
	ShaderPtr mNegShader;
	ShaderPtr mPixShader;
	ShaderPtr mRadBlurShader;
	ShaderPtr mBloomShader;
	ShaderPtr mPostProcess;

	std::unordered_map<PShader, ShaderPtr> mPostProcessShaders;
